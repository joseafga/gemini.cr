module Gemini
  ...
  struct Part
    ...
    one_of data : (Text | FunctionCall | FunctionResponse | InlineData)
  end
  ...
  # Raw media bytes.
  # Text should not be sent as raw bytes, use the `Text` type.
  #
  # [API Reference](https://ai.google.dev/api/caching#Blob)
  struct Blob
    include JSON::Serializable
    # The IANA standard MIME type of the source data.
    # Examples: **"image/png"** If an unsupported MIME type is provided, an error will be returned.
  ...
  #
  # [API Reference](https://ai.google.dev/api/generate-content#BlockReason)
  enum BlockReason
